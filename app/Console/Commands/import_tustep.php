...
class import_tustep extends Command {

    protected $signature = 'import:tustep {file?}';
    protected $description = 'Import and convert raw TUSTEP data';
    ...
    public function handle() {
        ...
        $file = trim($this->argument('file') ?? 'persons_original');
        $file = explode('.', $file);
        $file = trim($file[0].'.json');
        ...
        file_put_contents('data/'.$file, json_encode($data, JSON_UNESCAPED_UNICODE));
        echo "done\n\n";
